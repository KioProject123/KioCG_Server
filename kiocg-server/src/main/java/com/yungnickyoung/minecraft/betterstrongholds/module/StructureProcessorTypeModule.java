...
public class StructureProcessorTypeModule {
    ...
    public static StructureProcessorType<StructureProcessor> ARMORSTAND_PROCESSOR = () -> ArmorStandProcessor.CODEC;

    @AutoRegister("itemframe_processor")
    public static StructureProcessorType<StructureProcessor> ITEMFRAME_PROCESSOR = () -> ItemFrameProcessor.CODEC;
}
