...
public class StructureProcessorModule {
    ...
    public static StructureProcessorType<StructureProcessor> ARMOR_STAND_PROCESSOR = () -> ArmorStandProcessor.CODEC;

    @AutoRegister("item_frame_processor")
    public static StructureProcessorType<StructureProcessor> ITEM_FRAME_PROCESSOR = () -> ItemFrameProcessor.CODEC;

    @AutoRegister("pharaoh_processor")
    public static StructureProcessorType<StructureProcessor> PHARAOH_PROCESSOR = () -> PharaohProcessor.CODEC;
}
